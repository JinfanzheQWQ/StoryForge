...
const segment = {
  ...
  character_references: [{ name: "林屿.png", url: "/linyu.png", path: "/linyu.png" }],
  ...
  seedance_motion_prompt: "图片1为空场景母图，林屿从入口走入并完成等待动作。",
  motion_plan: { scene_motion: "从等待到抬头", camera_path: "固定中景轻微呼吸感" },
  diagnostics: {
    status: "warning",
    risk_types: ["尾部留空"],
    action_node_count: 2,
...
const artifacts = {
  ...
  scene_frames: [segment.scene_master_frame],
